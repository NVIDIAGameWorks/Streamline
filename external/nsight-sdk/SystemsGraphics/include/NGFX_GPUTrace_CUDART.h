...
//--------------------------------------------------------------------------------------
// File: NGFX_GPUTrace_CUDART.h
//
// Distributed as part of the NVIDIA Nsight Graphics SDK.
//--------------------------------------------------------------------------------------

#ifndef NGFX_GPUTRACE_CUDART_H
#define NGFX_GPUTRACE_CUDART_H
...
/**
 * @brief Injects the GPU Trace activity into a CUDART application.
 *
 ...
 */
NGFX_FUNCTION NGFX_Result NGFX_GPUTrace_Inject_CUDART(NGFX_GPUTrace_Inject_CUDART_Params* params)
{
    return NGFX_InjectActivity(NGFX_ActivityType_GPUTrace, params->installationPath, params->settings);
}

/**
 * @brief Initialize the GPU Trace activity in an already injected CUDART application
 *
 * @param params injection parameters
 * @return NGFX_Result_Success if the initialization is successful, or an appropriate error code.
 */
NGFX_FUNCTION NGFX_Result NGFX_GPUTrace_InitializeActivity_CUDART(NGFX_GPUTrace_InitializeActivity_CUDART_Params* params)
{
    return NGFX_Do_InitializeActivity(NGFX_ActivityType_GPUTrace, NGFX_ApiType_CUDART, (void*)params);
}
 ...
 */
NGFX_FUNCTION NGFX_Result NGFX_GPUTrace_ActivateTrace_CUDART(NGFX_GPUTrace_ActivateTrace_CUDART_Params* params)
{
    return g_NGFX_Globals.GPUTrace.ActivateTraceCUDART(params);
}
 ...
 */
NGFX_FUNCTION NGFX_Result NGFX_GPUTrace_StartTrace_CUDART(NGFX_GPUTrace_StartTrace_CUDART_Params* params)
{
    return g_NGFX_Globals.GPUTrace.StartTraceCUDART(params);
}
 ...
 */
NGFX_FUNCTION NGFX_Result NGFX_GPUTrace_StopTrace_CUDART(NGFX_GPUTrace_StopTrace_CUDART_Params* params)
{
    return g_NGFX_Globals.GPUTrace.StopTraceCUDART(params);
}
