...
//--------------------------------------------------------------------------------------
// File: NGFX_GPUTrace_D3D12.h
//
// Distributed as part of the NVIDIA Nsight Graphics SDK.
//--------------------------------------------------------------------------------------

#ifndef NGFX_GPUTRACE_D3D12_H
#define NGFX_GPUTRACE_D3D12_H
...
/**
 * @brief Injects the GPU Trace activity into a D3D12 application.
 *
 ...
 */
NGFX_FUNCTION NGFX_Result NGFX_GPUTrace_Inject_D3D12(NGFX_GPUTrace_Inject_D3D12_Params* params)
{
    return NGFX_InjectActivity(NGFX_ActivityType_GPUTrace, params->installationPath, params->settings);
}

/**
 * @brief Initialize the GPU Trace activity in an already injected D3D12 application
 *
 * @param params injection parameters
 * @return NGFX_Result_Success if the initialization is successful, or an appropriate error code.
 */
NGFX_FUNCTION NGFX_Result NGFX_GPUTrace_InitializeActivity_D3D12(NGFX_GPUTrace_InitializeActivity_D3D12_Params* params)
{
    return NGFX_Do_InitializeActivity(NGFX_ActivityType_GPUTrace, NGFX_ApiType_D3D12, (void*)params);
}
 ...
 */
NGFX_FUNCTION NGFX_Result NGFX_GPUTrace_ActivateTrace_D3D12(NGFX_GPUTrace_ActivateTrace_D3D12_Params* params)
{
    return g_NGFX_Globals.GPUTrace.ActivateTraceD3D12(params);
}
 ...
 */
NGFX_FUNCTION NGFX_Result NGFX_GPUTrace_StartTrace_D3D12(NGFX_GPUTrace_StartTrace_D3D12_Params* params)
{
    return g_NGFX_Globals.GPUTrace.StartTraceD3D12(params);
}
 ...
 */
NGFX_FUNCTION NGFX_Result NGFX_GPUTrace_StopTrace_D3D12(NGFX_GPUTrace_StopTrace_D3D12_Params* params)
{
    return g_NGFX_Globals.GPUTrace.StopTraceD3D12(params);
}
