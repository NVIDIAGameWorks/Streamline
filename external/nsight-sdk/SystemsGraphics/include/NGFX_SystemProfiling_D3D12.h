...
//--------------------------------------------------------------------------------------
// File: NGFX_SystemProfiling_D3D12.h
//
// Distributed as part of the NVIDIA Nsight Graphics SDK.
//--------------------------------------------------------------------------------------

#ifndef NGFX_SYSTEM_PROFILING_D3D12_H
#define NGFX_SYSTEM_PROFILING_D3D12_H
...
/**
 * @brief Injects the SystemProfiling activity into a D3D12 application.
 *
 ...
 */
NGFX_FUNCTION NGFX_Result NGFX_SystemProfiling_Inject_D3D12(NGFX_SystemProfiling_Inject_D3D12_Params* params)
{
    return NGFX_InjectActivity(NGFX_ActivityType_SystemProfiling, params->installationPath, params->settings);
}

/**
 * @brief Initialize the System profiling activity in an already injected D3D12 application
 *
 * @param params injection parameters
 * @return NGFX_Result_Success if the initialization is successful, or an appropriate error code.
 */
NGFX_FUNCTION NGFX_Result NGFX_SystemProfiling_InitializeActivity_D3D12(NGFX_SystemProfiling_InitializeActivity_D3D12_Params* params)
{
    return NGFX_Do_InitializeActivity(NGFX_ActivityType_SystemProfiling, NGFX_ApiType_D3D12, (void*)params);
}
 ...
 */
NGFX_FUNCTION NGFX_Result NGFX_SystemProfiling_StartProfiling_D3D12(NGFX_SystemProfiling_StartProfiling_D3D12_Params* params)
{
    // System profiling is handled through injection, so this is a simple success for D3D12
 ...
 */
NGFX_FUNCTION NGFX_Result NGFX_SystemProfiling_StopProfiling_D3D12(NGFX_SystemProfiling_StopProfiling_D3D12_Params* params)
{
    // System profiling is handled through injection, so this is a simple success for D3D12
    (void)params; // Suppress unused parameter warning
    return NGFX_Result_Success;
...
#endif // NGFX_SYSTEM_PROFILING_D3D12_H
